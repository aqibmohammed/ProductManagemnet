...
const EditProduct = () => {
  ...
  const { productName, model, cost, make, quantity } = productData;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:8080/api/v1/products/${productData.id}?${queryParams}`
      );
    ...
    <Main>
      <FormContainer>
        <Form onSubmit={handleSubmit}>
          ...
          <Input
            type="text"
            placeholder="Enter Product model to update"
            id="model"
            name="model"
            value={model}
            onChange={handleInputChange}
          ...
          <Input
            type="text"
            id="make"
            placeholder="Enter Product make to update"
            name="make"
            value={make}
            onChange={handleInputChange}
          />
          ...
          <Input
            type="number"
            placeholder="Enter Product Cost to update"
            id="cost"
            name="cost"
            value={cost}
            onChange={handleInputChange}
          ...
          <Input
            ...
            id="quantity"
            name="quantity"
            placeholder="Enter Product quantity to update"
            value={quantity}
            onChange={handleInputChange}
          />
